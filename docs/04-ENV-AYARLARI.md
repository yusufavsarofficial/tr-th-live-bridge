...
## Render Environment notu

Render/Railway panelinde env degerlerini tek tek gir. `DATABASE_URL` Neon veya Supabase PostgreSQL connection string olmalidir. `OPENAI_API_KEY` sadece backend environment alaninda tutulur.

Android icine secret, API key veya database bilgisi yazilmaz.